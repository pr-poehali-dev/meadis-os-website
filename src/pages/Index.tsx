          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="backdrop-blur-md bg-white/70 border-white/60 shadow-xl p-8 rounded-3xl hover:scale-105 transition-transform relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-foreground/70">
                  Оптимизированная производительность для быстрой работы всех приложений
                </p>
              </div>
            </Card>
            ...
            <Card className="backdrop-blur-md bg-white/70 border-white/60 shadow-xl p-8 rounded-3xl hover:scale-105 transition-transform relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-foreground/70">
                  Встроенная защита данных и конфиденциальности на всех уровнях системы
                </p>
              </div>
            </Card>
            ...
            <div className="relative z-10 flex items-center gap-8">
              ...
              <div className="flex-grow">
                ...
                <div className="flex gap-3">
                  ...
                  <Button className="bg-gradient-to-r from-aero-green to-aero-yellow text-white shadow-lg hover:shadow-xl transition-all relative overflow-hidden group rounded-xl">
                    <div className="absolute inset-0 bg-gradient-to-b from-white/30 to-transparent"></div>
                    <span className="relative z-10 flex items-center gap-2">
                      <Icon name="Download" size={18} />
                      macOS
